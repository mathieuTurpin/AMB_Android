...
public class UtilisateurController extends Controller
{
	...
	public Map<String,String> prepareUpdate(String id, String nom, String prenom, String email, String description, String partagePosition, String partagePositionPublic){
		Map<String,String> formValues = new HashMap<String, String>();
		formValues.put("id", id);
		formValues.put("nom", nom);
		formValues.put("prenom", prenom);
		formValues.put("email", email);
		formValues.put("mot_de_passe", "amb");
		formValues.put("url_avatar", "");
		formValues.put("description", description);
		formValues.put("partage_position", partagePosition);
		formValues.put("partage_position_public", partagePositionPublic);
